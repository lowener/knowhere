...
struct raft_index {
    ...
    using index_params_type = std::conditional_t<
        vector_index_kind == raft_index_kind::brute_force, cuvs::neighbors::brute_force::index_params, // Generic index params for BF
        std::conditional_t<
    ...
    using search_params_type = std::conditional_t<
        vector_index_kind == raft_index_kind::brute_force, cuvs::neighbors::brute_force::search_params, // Generic search params for BF
        std::conditional_t<
